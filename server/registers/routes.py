...
def init_app(app: Flask):
    ...
    """
    try:
        from server.controllers import article_controller, explore_controller, home_controller, pouso_lunar_controller

        app.register_blueprint(home_controller.bp)
        app.register_blueprint(article_controller.bp)
        app.register_blueprint(explore_controller.bp)
